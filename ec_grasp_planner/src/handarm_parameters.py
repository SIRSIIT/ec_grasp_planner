...
class PisaHand(BaseHand):
    def __init__(self):
        ...
        self['surface_grasp']['object']['hand_transform'] = tra.concatenate_matrices(tra.translation_matrix([0.010, 0.007, 0.115]))
        ...
        self['surface_grasp']['object']['hand_pose'] = tra.translation_matrix([0.010, 0.007, 0.115])
        self['surface_grasp']['object']['downward_force'] = 7.
        self['surface_grasp']['object']['pregrasp_transform'] = tra.concatenate_matrices(tra.translation_matrix([0.3,-0.03,0.05]),tra.euler_matrix(-math.pi/2,0,-math.pi/2),tra.euler_matrix(0,0,-0.5))
...
class RBOHand2Kuka(RBOHand2):
    def __init__(self, **kwargs):
        ...
        self['edge_grasp']['pregrasp_pose'] = tra.translation_matrix([0.2, 0, 0.4])
